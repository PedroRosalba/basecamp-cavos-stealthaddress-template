...
export function ConnectedWallet() {
  ...
  const handleBalance = async () => {
    ...
    try {
      ...
      const fraction = (rawBalance % decimals)
        .toString()
        .padStart(18, "0")
        .slice(0, 4);
      const trimmedFraction = fraction.replace(/0+$/, "");
      const formattedBalance = trimmedFraction
        ? `${whole.toString()}.${trimmedFraction} STRK`
        : `${whole.toString()} STRK`;
        ...
        <DropdownMenuContent align="end" className="w-80 p-4">
          <DropdownMenuLabel className="px-0 pb-4">
            ...
            <div className="text-xs font-normal text-zinc-500">
              Test your wallet by sending a transaction.
            </div>
          </DropdownMenuLabel>
          <div className="flex flex-col gap-4">
            ...
            <Button
              ...
              disabled={!walletStatus.isReady || !recipientAddress || !amount}
            >
              Execute Transaction
            </Button>
            {lastTxHash ? (
        ...
        <DropdownMenuContent align="end" className="w-80 p-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button
              ...
              className="w-full"
              disabled={isLoadingBalance || !walletStatus.isReady}
            >
